...
CREATE TABLE public.stocker(
	id          INT  NOT NULL ,
	id_guilds   INT  NOT NULL  ,
	CONSTRAINT stocker_PK PRIMARY KEY (id,id_guilds)

	,CONSTRAINT stocker_roles_FK FOREIGN KEY (id) REFERENCES public.roles(id)
	,CONSTRAINT stocker_guilds0_FK FOREIGN KEY (id_guilds) REFERENCES public.guilds(id)
)WITHOUT OIDS;
